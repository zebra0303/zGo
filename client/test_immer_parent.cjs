...
console.log(
  "Are tree root and current parent the same object?",
  nextState.tree === nextState.current.parent,
);
...
console.log(
  "After root update - Current parent val:",
  nextState2.current.parent.val,
);
